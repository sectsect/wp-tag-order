<?php
	...
	$count = 0;
	$pts = wto_has_tag_posttype();	// Get All Post-types that holds the non-hierarchical taxonomies
	foreach ($pts as $pt) {
		// Get post_ids from All Post-types that holds the non-hierarchical taxonomies
		$ids = array();
